...
// Data achive from files
        ...
        $mainpassword=substr(sha1($mainpassword),0,10);
        echo $mainpassword;
        $Name = trim(fgets($fo));
...
?>
  ...
  <main class="table-secondary">
    <form class=" border border-danger m-auto" style="width:700px;" method="POST">
      ...
      <div class="form-group">
        <input type="password" class="form-control col-8 m-auto" placeholder="New Password" name="newpass">
      </div>
      
      <div class="form-group">
        <input type="password" class="form-control col-8 m-auto" placeholder="Confirm Password" name="conpassword">
      </div>
